<script>
    ...
    /*
     * The Drafts component will tell us whether this is
     * the Red or Green division.
     *
     * Default to Red so existing drafts continue to work.
     */
    ...
    /*
     * Send the division along when opening a manager.
     *
     * Red:
    ...
    <div class="accuracy">
        ...
        <div class="accuracyText">
            ...
            <span class="disclaimer">
                (accuracy will improve as the regular season progresses)
            </span>
                ...
                {#if draftPosition}
                    ...
                    <Cell class="draftTeam">
                        ...
                        <img
                            ...
                            onclick={() => openManager(draftPosition)}
